...
using XamarinBarCode_Test.Models;
using XamarinBarCode_Test.Views;
...
namespace XamarinBarCode_Test.ViewModels
{
    public class MatrixScanPageViewModel : IBarcodeTrackingListener, IBarcodeTrackingAdvancedOverlayListener
    {
        ...
        public Camera Camera { get; private set; } = ScannerModelMatrix.Instance.CurrentCamera;
        public DataCaptureContext DataCaptureContext { get; private set; } = ScannerModel.Instance.DataCaptureContext;
        public BarcodeTracking BarcodeTracking { get; private set; } = ScannerModelMatrix.Instance.BarcodeTracking;
        public Func<TrackedBarcode, bool> ShouldHideOverlay;

        public MatrixScanPageViewModel()
        {
